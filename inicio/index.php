...
$titulo="Catálago de Registro de entradas de Alumnos";
$opcionMenu="A";
			...
			<div class="col-xs-12 col-sm-9 col-md-10 col-lg-10 cont">
			   ...
			   <div class="contenido borde sombra">
				    <div class="container-fluid">
						...
						<section id="lista1" style="display: none; width: 100%">
							
						</section>
				        <section id="lista" style="width: 100%">
            					
				        </section>
				        <section id="lista2" style="display: none; width: 100%">
				        	
				        </section>
				        <section id="lista3" style="display: none; width: 100%">
